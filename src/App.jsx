...
const checkCode=()=>{
if(code==="MESSIH2025"||code==="MESSIH"){
setVip(true);
setShow(false);
alert("VIP Activated! Welcome!");
}else{
alert("Wrong Code! Lipa na M-Pesa first.");
}
};
...
{!vip?<button onClick={()=>setShow(true)} style={{background:"#4ade80",color:"black",padding:"15px 30px",fontWeight:"bold",border:"none",borderRadius:"8px",fontSize:"18px"}}>Unlock VIP - 10 Games</button>:<div style={{background:"#4ade80",color:"black",padding:"10px",borderRadius:"8px",fontWeight:"bold"}}>VIP ACTIVE - All Games Unlocked ✅</div>}
</div>
...
<div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span>Tip: <b style={{color:"#4ade80"}}>{(g.league==="Jackpot"&&!vip)?"🔒 VIP ONLY":g.tip}</b></span><span style={{background:"#4ade80",color:"black",padding:"5px 10px",borderRadius:"4px",fontWeight:"bold"}}>{g.odd}</span></div>
</div>
))}
</div>
...
<div style={{background:"white",color:"black",padding:"15px",textAlign:"center",borderRadius:"8px",margin:"15px 0"}}>
<p>Buy Goods Till</p>
<p style={{fontSize:"30px",fontWeight:"900",color:"#4ade80"}}>1581046</p>
<p>Name: MESSIH</p>
</div>
<p style={{textAlign:"center"}}>After payment, enter code sent to WhatsApp 0793921100</p>
...
<a href="https://wa.me/254793921100" target="_blank" style={{display:"block",textAlign:"center",background:"#25D366",color:"white",padding:"12px",borderRadius:"8px",textDecoration:"none",marginTop:"15px",fontWeight:"bold"}}>Confirm Payment on WhatsApp 0793921100</a>
</div>
</div>}
